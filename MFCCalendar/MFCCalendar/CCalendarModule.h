...
// CCalendarModule 包装器类

class CCalendarModule : public COleDispatchDriver
{
public:
	CCalendarModule() {} // 调用 COleDispatchDriver 默认构造函数
	CCalendarModule(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CCalendarModule(const CCalendarModule& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
