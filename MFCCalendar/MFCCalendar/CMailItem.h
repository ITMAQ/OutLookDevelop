...
class CMailItem : public COleDispatchDriver
{
public:
	CMailItem() {} // 调用 COleDispatchDriver 默认构造函数
	CMailItem(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CMailItem(const CMailItem& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	{
		CString result;
		InvokeHelper(0x43, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
		return result;
	}
	CString get_ReceivedOnBehalfOfName()
	{
		CString result;
		InvokeHelper(0x44, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
		return result;
	}
	...
	{
		long result;
		InvokeHelper(0x8511, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	void put_RemoteStatus(long newValue)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x8511, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	...
	{
		CString result;
		InvokeHelper(0xf01b, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
		return result;
	}
	void put_VotingOptions(LPCTSTR newValue)
	{
		static BYTE parms[] = VTS_BSTR;
		InvokeHelper(0xf01b, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	CString get_VotingResponse()
	{
		CString result;
		InvokeHelper(0x8524, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
		return result;
	}
	void put_VotingResponse(LPCTSTR newValue)
	{
		static BYTE parms[] = VTS_BSTR;
		InvokeHelper(0x8524, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	void ClearConversationIndex()
	{
		InvokeHelper(0xf822, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	LPDISPATCH Forward()
	{
		LPDISPATCH result;
	...
	{
		long result;
		InvokeHelper(0xfa49, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	void put_BodyFormat(long newValue)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0xfa49, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	...
	{
		BOOL result;
		InvokeHelper(0x859b, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_IsIPFax(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0x859b, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	long get_FlagIcon()
	{
		long result;
	...
	{
		BOOL result;
		InvokeHelper(0xfab0, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_HasCoverSheet(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0xfab0, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	...
	{
		BOOL result;
		InvokeHelper(0xfac4, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_EnableSharedAttachments(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0xfac4, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	long get_Permission()
	{
		long result;
		InvokeHelper(0xfac6, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	void put_Permission(long newValue)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0xfac6, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	long get_PermissionService()
	{
		long result;
		InvokeHelper(0xfacb, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	void put_PermissionService(long newValue)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0xfacb, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	...
	{
		static BYTE parms[] = VTS_DISPATCH;
		InvokeHelper(0xfb96, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, contact);
	}
	...
	{
		LPDISPATCH result;
		InvokeHelper(0xfc7b, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	void put_Sender(LPDISPATCH newValue)
	{
		static BYTE parms[] = VTS_DISPATCH;
		InvokeHelper(0xfc7b, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	CString get_PermissionTemplateGuid()
	{
		CString result;
		InvokeHelper(0xfc7d, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
		return result;
	}
	void put_PermissionTemplateGuid(LPCTSTR newValue)
	{
		static BYTE parms[] = VTS_BSTR;
		InvokeHelper(0xfc7d, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	VARIANT get_RTFBody()
	{
		VARIANT result;
