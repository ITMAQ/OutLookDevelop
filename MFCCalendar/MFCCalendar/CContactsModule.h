...
// CContactsModule 包装器类

class CContactsModule : public COleDispatchDriver
{
public:
	CContactsModule() {} // 调用 COleDispatchDriver 默认构造函数
	CContactsModule(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CContactsModule(const CContactsModule& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
