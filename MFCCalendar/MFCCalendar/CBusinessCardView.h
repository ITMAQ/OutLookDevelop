...
// CBusinessCardView 包装器类

class CBusinessCardView : public COleDispatchDriver
{
public:
	CBusinessCardView() {} // 调用 COleDispatchDriver 默认构造函数
	CBusinessCardView(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CBusinessCardView(const CBusinessCardView& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	{
		long result;
		InvokeHelper(0xfbda, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	void put_CardSize(long newValue)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0xfbda, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}

	// _BusinessCardView 属性
public:
